...
export class concernService {
  ...
  apiUrl: string = environment.apiUrl + "concern"
  ...
  getConcernByProductCategory(productCategory:any){
    return this.http.get(this.apiUrl + '/' + productCategory, this._httpHeaders);
  }
}
