...
export class TechnicalAssistantEmployeeService {

  private _httpHeaders:any;

  apiUrl: string = environment.apiUrl + "technicalAssistantEmployee"
  ...
  getAllTechnicalAssistant() {
    return this.http.get(this.apiUrl + "/getAllTechnicalAssistant" + "?size=2000&page=0&sort=createdAt,desc", this._httpHeaders);
  }
  getDataById() {
