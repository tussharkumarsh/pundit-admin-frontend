...
import { SortDirection, SortColumn } from './Invoice-sortable.directive';
...
function matches(table: Table, term: string, pipe: PipeTransform) {
    return table.invoice_id.toLowerCase().includes(term.toLowerCase())
        || table.date.toLowerCase().includes(term.toLowerCase())
        || table.billing_name.toLowerCase().includes(term.toLowerCase())
        || table.amount.toLowerCase().includes(term.toLowerCase())
        || table.status.toLowerCase().includes(term.toLowerCase())
        || table.pdf.toLowerCase().includes(term.toLowerCase())
        || table.action.toLowerCase().includes(term.toLowerCase());
}
